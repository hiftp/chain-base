...
class EcpayInvocieResConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        res.update(
            ...
            ecpay_allowance_domain=self.env['ir.config_parameter'].sudo().get_param(
                'ecpay_invoice_tw.ecpay_allowance_domain')
    ...
    def set_values(self):
        ...
        self.env['ir.config_parameter'].sudo().set_param('ecpay_invoice_tw.ecpay_allowance_domain',
                                                         self.ecpay_allowance_domain)
