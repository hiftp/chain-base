odoo.define('interface.abc.search.wages.result', function (require) {
    "use strict";
    ...
    let InterfaceABCSearchWagesResult = Widget.extend({
        events: {
            ...
            "click #search": function (env) {
                ...
                new Model('interface.abc.search.wages.result').call('search_wages_result', [account_id, form_code])
                    .then(function (res) {
                        self.$el.find('#search_result').html(QWeb.render("InterfaceABCSearchWagesResultLine", {
                            widget: self,
                            data: res,
                        }));
        ...
        start: function () {
            let self = this;
            self.$el.html(QWeb.render("InterfaceABCSearchWagesResult", {widget: self}));
    ...
    core.action_registry.add('search_abc_wages_result', InterfaceABCSearchWagesResult);
